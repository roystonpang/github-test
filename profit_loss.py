...
def profitloss_function(forex):
    """
    - function will determine the day where net profit is lower 
    ...
    for amount in profit_loss_list:
        ...
        if float(amount["net profit"]) < net_profit:
            # the difference is multiplied by the conversion rate and appended to difference empty list
            difference.append((net_profit - float(amount["net profit"])) * forex)
            # corresponding day will be appended to day empty list
